let handler = async (m, { conn }) => {
    let __timers = (new Date() - (global.db.data.users[m.sender].lastmisi || 0))
    let _timers = (300000 - __timers) // 5 menit dalam milidetik
    ...
    if (new Date() - user.lastmisi > 300000) { // 5 menit dalam milidetik
