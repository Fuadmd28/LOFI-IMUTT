let handler = async (m, { isPrems, args, conn, text, command, usedPrefix }) => {
    ...
    const jobRequirements = {
        ...
        'kurir': { min: 10, max: 20 },
        'sopir': { min: 10, max: 20 },
        'karyawan indomaret': { min: 20, max: 30 },
        'kantoran': { min: 30, max: 40 },
        'dokter': { min: 50, max: 100 },
        'frontend developer': { min: 40, max: 60 },
        'web developer': { min: 40, max: 60 },
        'backend developer': { min: 40, max: 60 },
        'fullstack developer': { min: 50, max: 70 },
        'game developer': { min: 40, max: 60 },
        'pemain sepak bola': { min: 30, max: 50 },
        'trader': { min: 40, max: 60 },
        'hunter': { min: 20, max: 30 },
        'polisi': { min: 30, max: 50 }
    };
