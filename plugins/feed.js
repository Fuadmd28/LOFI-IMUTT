let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    switch (type) {
        ...
        case 'kuda':
            ...
            let __waktuk = (new Date - global.db.data.users[m.sender].anjinglastclaim)
            let _waktuk = (600000 - __waktuk)
            let waktuk = clockString(_waktuk)
            ...
            let __waktuk = (new Date - global.db.data.users[m.sender].kyubilastclaim)
            let _waktuk = (600000 - __waktuk)
            let waktuk = clockString(_waktuk)
            ...
            let __waktuk = (new Date - global.db.data.users[m.sender].centaurlastclaim)
            let _waktuk = (600000 - __waktuk)
            let waktuk = clockString(_waktuk)
            ...
            let __waktuk = (new Date - global.db.data.users[m.sender].griffinlastclaim)
            let _waktuk = (600000 - __waktuk)
            let waktuk = clockString(_waktuk)
